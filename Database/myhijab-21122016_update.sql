...
--
-- Host: 127.0.0.1
-- Generation Time: 21 Des 2016 pada 15.03
-- Versi Server: 5.6.16
-- PHP Version: 5.5.11
...
--
-- Struktur dari tabel `affiliate_activity`
--
...
--
-- Struktur dari tabel `affiliate_login`
--
...
--
-- Struktur dari tabel `affiliate_transaction`
--
...
--
-- Dumping data untuk tabel `api_ip`
--
...
(450, 1, 'QIM9Ke3KDbeOugptRok2HDyTqzKWmWh7', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a8a2f601ed', '::1', '2016-12-21 20:57:03', '2016-12-21 20:57:03'),
(449, 1, '8Ih82YQrKACQyXQlEpdOR6PBrRjEwm86', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a89ee3f2ef', '::1', '2016-12-21 20:55:58', '2016-12-21 20:55:58'),
(448, 1, 'ayAN06yC4sCaLmV47yBeZG9Pp8PWYdMy', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a89c4786eb', '::1', '2016-12-21 20:55:16', '2016-12-21 20:55:16'),
(447, 1, 'wJs9PR1uQQMQveUOux8lHlb4r7N2APO5', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a89a823ced', '::1', '2016-12-21 20:54:48', '2016-12-21 20:54:48'),
(446, 1, 'xELcoSQKc4qkXG6MHSevdpBCW4DkYis4', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a86faec940', '::1', '2016-12-21 20:43:22', '2016-12-21 20:43:41'),
(445, 1, 'bPWMRo9uBJZI735OVJdBRgUZ5BjozCJH', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a8339934ee', '::1', '2016-12-21 20:27:21', '2016-12-21 20:34:41'),
(444, 1, '3N0yJGl8gkV1JwDidC55k0sBCZQDQUQp', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a81f844ebb', '::1', '2016-12-21 20:22:00', '2016-12-21 20:22:00'),
(442, 1, 'GovlHDwHqVV0bVCMhc0Ew5TH0jNXY4zR', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a81846a386', '::1', '2016-12-21 20:20:04', '2016-12-21 20:20:04'),
(443, 1, 'zj7egeL3pzTKkZeGmmyTxXjFA83a4n6b', 'btuer92vepo3t2443k2du382f2', 'temp_session_585a818c96c4a', '::1', '2016-12-21 20:20:12', '2016-12-21 20:20:12');
...
--
-- Struktur dari tabel `attribute_description`
--
...
--
-- Dumping data untuk tabel `attribute_description`
--
...
--
-- Struktur dari tabel `attribute_group`
--
...
--
-- Dumping data untuk tabel `attribute_group`
--
...
--
-- Struktur dari tabel `attribute_group_description`
--
...
--
-- Dumping data untuk tabel `attribute_group_description`
--
...
--
-- Struktur dari tabel `banner_image_description`
--
...
--
-- Dumping data untuk tabel `banner_image_description`
--
...
(59, 1, 'btuer92vepo3t2443k2du382f2', 59, 0, '[]', 1, '2016-12-21 20:43:30');
...
--
-- Struktur dari tabel `category_filter`
--
...
--
-- Struktur dari tabel `category_to_layout`
--
...
CREATE TABLE IF NOT EXISTS `city` (
  ...
  `sort_order` int(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`city`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6515 ;
...
--
-- Struktur dari tabel `coupon_category`
--
...
--
-- Struktur dari tabel `coupon_history`
--
...
--
-- Struktur dari tabel `coupon_product`
--
...
--
-- Struktur dari tabel `custom_field`
--
...
--
-- Struktur dari tabel `custom_field_customer_group`
--
...
--
-- Struktur dari tabel `custom_field_description`
--
...
--
-- Struktur dari tabel `custom_field_value`
--
...
--
-- Struktur dari tabel `custom_field_value_description`
--
...
--
-- Struktur dari tabel `customer_activity`
--
...
--
-- Struktur dari tabel `customer_group_description`
--
...
--
-- Dumping data untuk tabel `customer_group_description`
--
...
--
-- Struktur dari tabel `customer_history`
--
...
--
-- Struktur dari tabel `customer_ip`
--
...
--
-- Dumping data untuk tabel `customer_ip`
--
...
--
-- Struktur dari tabel `customer_login`
--
...
--
-- Struktur dari tabel `customer_online`
--
...
--
-- Struktur dari tabel `customer_reward`
--
...
--
-- Struktur dari tabel `customer_transaction`
--
...
--
-- Struktur dari tabel `customer_wishlist`
--
...
--
-- Struktur dari tabel `download_description`
--
...
--
-- Struktur dari tabel `filter_description`
--
...
--
-- Struktur dari tabel `filter_group`
--
...
--
-- Struktur dari tabel `filter_group_description`
--
...
--
-- Struktur dari tabel `information_description`
--
...
--
-- Dumping data untuk tabel `information_description`
--
...
--
-- Struktur dari tabel `information_to_layout`
--
...
--
-- Struktur dari tabel `information_to_store`
--
...
--
-- Dumping data untuk tabel `information_to_store`
--
...
--
-- Struktur dari tabel `layout_module`
--
...
--
-- Dumping data untuk tabel `layout_module`
--
...
--
-- Struktur dari tabel `manufacturer_to_store`
--
...
--
-- Dumping data untuk tabel `manufacturer_to_store`
--
...
--
-- Struktur dari tabel `modification`
--
...
--
-- Struktur dari tabel `order_custom_field`
--
...
--
-- Struktur dari tabel `order_option`
--
...
--
-- Struktur dari tabel `order_recurring`
--
...
--
-- Struktur dari tabel `order_recurring_transaction`
--
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `capital_price` decimal(15,4) NOT NULL,
  `price` decimal(15,4) NOT NULL DEFAULT '0.0000',
  `points` int(8) NOT NULL DEFAULT '0',
...
INSERT INTO `product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `capital_price`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`) VALUES
(59, 'Tes', '', '', '', '', '', '', '', 2, 5, 'catalog/product/greenism/greenism_cordoba_tropica_banana.jpg', 11, 1, '110000.0000', '130000.0000', 0, 0, '2016-09-15', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, 0, '2016-09-15 16:27:08', '2016-10-20 16:07:02');
...
(59, 1, 'Greenism Hijab', '&lt;p&gt;Greenism Hijab&lt;/p&gt;', '', 'Greenism Hijab', '', ''),
(59, 2, 'Greenism Hijab', '&lt;p&gt;Greenism Hijab&lt;br&gt;&lt;/p&gt;', '', 'Greenism Hijab', '', '');
...
--
-- Struktur dari tabel `product_filter`
--
...
--
-- Struktur dari tabel `product_recurring`
--
...
--
-- Struktur dari tabel `product_related`
--
...
--
-- Struktur dari tabel `product_reward`
--
...
CREATE TABLE IF NOT EXISTS `product_size` (
  ...
  `extra_small` int(5) NOT NULL,
  `small` int(5) NOT NULL,
  `medium` int(5) NOT NULL,
  `large` int(5) NOT NULL,
  `extra_large` int(5) NOT NULL,
  `double_extra_large` int(5) NOT NULL,
  PRIMARY KEY (`product_id`)
...
INSERT INTO `product_size` (`product_id`, `extra_small`, `small`, `medium`, `large`, `extra_large`, `double_extra_large`) VALUES
(59, 1, 1, 1, 1, 1, 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `product_special`
--
...
--
-- Struktur dari tabel `product_to_download`
--
...
--
-- Struktur dari tabel `product_to_layout`
--
...
--
-- Dumping data untuk tabel `product_to_layout`
--
...
--
-- Struktur dari tabel `recurring_description`
--
...
--
-- Struktur dari tabel `return_action`
--
...
--
-- Dumping data untuk tabel `return_action`
--
...
--
-- Struktur dari tabel `return_history`
--
...
--
-- Struktur dari tabel `return_reason`
--
...
--
-- Dumping data untuk tabel `return_reason`
--
...
--
-- Struktur dari tabel `return_status`
--
...
--
-- Dumping data untuk tabel `return_status`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1372 ;
...
--
-- Struktur dari tabel `stock_status`
--
...
--
-- Dumping data untuk tabel `stock_status`
--
...
--
-- Dumping data untuk tabel `tax_class`
--
...
--
-- Dumping data untuk tabel `tax_rate`
--
...
--
-- Struktur dari tabel `tax_rate_to_customer_group`
--
...
--
-- Dumping data untuk tabel `tax_rate_to_customer_group`
--
...
--
-- Dumping data untuk tabel `tax_rule`
--
...
--
-- Dumping data untuk tabel `url_alias`
--
...
--
-- Struktur dari tabel `voucher_theme`
--
...
--
-- Dumping data untuk tabel `voucher_theme`
--
...
--
-- Struktur dari tabel `voucher_theme_description`
--
...
--
-- Dumping data untuk tabel `voucher_theme_description`
--
