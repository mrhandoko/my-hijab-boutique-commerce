...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$randcode = $this->model_sale_order->getOrder($result['order_id']);
			$data['orders'][] = array(
				'order_id'      => $result['order_id'],
				'customer'      => $result['customer'],
				'status'        => $result['status'],
				'total'         => $this->currency->format($result['total']-$randcode['random_code'], $result['currency_code'], $result['currency_value']),
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['text_airwaybill'] = $this->language->get('text_airwaybill');
			...
			foreach ($totals as $total) {
				...
				$randcode = $this->model_sale_order->getDataOrder($total['order_id']);

				if ($total['title'] == 'Total') { $total['value'] = $total['value'] - $randcode; } 
