...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		/*foreach ($results as $result) {
			...
			$product_size = $this->model_catalog_product->getProductSizes($result['product_id']);
			...
			$manufacturer = $this->model_catalog_product->getManufacturer($result['manufacturer_id']);
			...
			$data['products'][] = array(
				...
				'model'      => $result['model'],
				'capital_price' => $result['capital_price'],
				'price'      => $result['price'],
				'special'    => $special,
				//'quantity'   => $result['quantity'],
				'quantity'   => $product_size['extra_small'] + $product_size['small'] + $product_size['medium'] + $product_size['large'] + $product_size['extra_large'] + $product_size['double_extra_large'],
		...
		$data['column_capital_price'] = $this->language->get('column_capital_price');
	...
	protected function getForm() {
		...
		$data['entry_quantity'] = $this->language->get('entry_quantity');
		$data['entry_quantity_xs'] = $this->language->get('entry_quantity_xs');
		$data['entry_quantity_small'] = $this->language->get('entry_quantity_small');
		$data['entry_quantity_medium'] = $this->language->get('entry_quantity_medium');
		$data['entry_quantity_large'] = $this->language->get('entry_quantity_large');
		$data['entry_quantity_xl'] = $this->language->get('entry_quantity_xl');
		$data['entry_quantity_xxl'] = $this->language->get('entry_quantity_xxl');
		$data['entry_stock_status'] = $this->language->get('entry_stock_status');
		$data['entry_capital_price'] = $this->language->get('entry_capital_price');
		$data['entry_price'] = $this->language->get('entry_price');
		...
		if (isset($this->request->post['capital_price'])) {
			$data['capital_price'] = $this->request->post['capital_price'];
		} elseif (!empty($product_info)) {
			$data['capital_price'] = $product_info['capital_price'];
		} else {
			$data['capital_price'] = '';
		}
		...
		if (isset($product_info['product_id'])) {
			$product_size = $this->model_catalog_product->getProductSizes($product_info['product_id']);
			$data['product_size'] = $product_size;
		}
		...
		if (isset($this->request->post['quantity'])) {
			...
			$data['quantity'] = $product_size['extra_small'] + $product_size['small'] + $product_size['medium'] + $product_size['large'] + $product_size['extra_large'] + $product_size['double_extra_large'];
		} else {
			$data['quantity'] = 0;
		}

		if (isset($this->request->post['quantity_xs'])) {
			$data['quantity_xs'] = $this->request->post['quantity_xs'];
		} elseif (!empty($product_info)) {
			$data['quantity_xs'] = $product_size['extra_small'];
		} else {
			$data['quantity_xs'] = 0;
		}

		if (isset($this->request->post['quantity_small'])) {
			$data['quantity_small'] = $this->request->post['quantity_small'];
		} elseif (!empty($product_info)) {
			$data['quantity_small'] = $product_size['small'];
		} else {
			$data['quantity_small'] = 0;
		}

		if (isset($this->request->post['quantity_medium'])) {
			$data['quantity_medium'] = $this->request->post['quantity_medium'];
		} elseif (!empty($product_info)) {
			$data['quantity_medium'] = $product_size['medium'];
		} else {
			$data['quantity_medium'] = 0;
		}

		if (isset($this->request->post['quantity_large'])) {
			$data['quantity_large'] = $this->request->post['quantity_large'];
		} elseif (!empty($product_info)) {
			$data['quantity_large'] = $product_size['large'];
		} else {
			$data['quantity_large'] = 0;
		}

		if (isset($this->request->post['quantity_xl'])) {
			$data['quantity_xl'] = $this->request->post['quantity_xl'];
		} elseif (!empty($product_info)) {
			$data['quantity_xl'] = $product_size['extra_large'];
		} else {
			$data['quantity_xl'] = 0;
		}

		if (isset($this->request->post['quantity_xxl'])) {
			$data['quantity_xxl'] = $this->request->post['quantity_xxl'];
		} elseif (!empty($product_info)) {
			$data['quantity_xxl'] = $product_size['double_extra_large'];
		} else {
			$data['quantity_xxl'] = 0;
		}
