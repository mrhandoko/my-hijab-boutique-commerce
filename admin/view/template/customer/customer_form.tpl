      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
          ...
          <div class="tab-content">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10">                       
						  <select name="address[<?php echo $address_row; ?>][zone_id]" id="input-zone<?php echo $address_row; ?>" onchange="$('select[name=\'address[<?php echo $address_row; ?>][city]\']').load('index.php?route=customer/customer/city&token=<?php echo $token; ?>&zone_id=' + this.value);;" class="form-control">						  						  
                            <option value=""><?php echo $text_select; ?></option>
					  ...
					  <div class="form-group required">
                        ...
                        <div class="col-sm-10">
						<select name="address[<?php echo $address_row; ?>][city]" value="<?php echo $address['city']; ?>" placeholder="<?php echo $entry_city; ?>" id="input-city<?php echo $address_row; ?>" class="form-control" />
						</select>                          
		    ...
		    $('select[name=\'address[<?php echo $address_row; ?>][city]\']').load('index.php?route=customer/customer/city&token=<?php echo $token; ?>&zone_id=<?php echo $address['zone_id']; ?>&city=<?php echo $address['city']; ?>');
		    //--></script> 
                      </div>					  
                    </div>					
                    <?php $address_row++; ?>
...
function addAddress() {
	...
	html += '    <div class="col-sm-10"><select name="address[' + address_row + '][zone_id]" id="input-zone' + address_row + '" onchange="$(\'select[name=\\\'address[' + address_row + '][city]\\\']\').load(\'index.php?route=customer/customer/city&token=<?php echo $token; ?>&zone_id=\' + this.value);" class="form-control">';
	html += '    <option value=""><?php echo $text_select; ?></option>';
	html += '      </select></div>';
	html += '  </div>';
