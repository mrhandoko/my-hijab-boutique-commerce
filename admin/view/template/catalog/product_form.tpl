      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-links" data-toggle="tab"><?php //echo $tab_links; ?><?php echo "Brand"; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-capital-price"><?php echo $entry_capital_price; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="capital_price" value="<?php echo $capital_price; ?>" placeholder="<?php echo $entry_capital_price; ?>" id="input-capital-price" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity-xs"><?php echo $entry_quantity_xs; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_xs" value="<?php echo $quantity_xs; ?>" placeholder="<?php echo $entry_quantity_xs; ?>" id="input-quantity-xs" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity-small"><?php echo $entry_quantity_small; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_small" value="<?php echo $quantity_small; ?>" placeholder="<?php echo $entry_quantity_small; ?>" id="input-quantity-small" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity-medium"><?php echo $entry_quantity_medium; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_medium" value="<?php echo $quantity_medium; ?>" placeholder="<?php echo $entry_quantity_medium; ?>" id="input-quantity-medium" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity-large"><?php echo $entry_quantity_large; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_large" value="<?php echo $quantity_large; ?>" placeholder="<?php echo $entry_quantity_large; ?>" id="input-quantity-large" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity-xl"><?php echo $entry_quantity_xl; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_xl" value="<?php echo $quantity_xl; ?>" placeholder="<?php echo $entry_quantity_xl; ?>" id="input-quantity-xl" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity-xxl"><?php echo $entry_quantity_xxl; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity_xxl" value="<?php echo $quantity_xxl; ?>" placeholder="<?php echo $entry_quantity_xxl; ?>" id="input-quantity-xxl" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity"><?php echo $entry_quantity; ?></label>
