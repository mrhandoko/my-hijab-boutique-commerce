        ...
        <div class="panel panel-default">
          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                <td><?php echo $text_airwaybill; ?></td>
                <td id="invoice" class="text-right"><?php echo $airwaybill_no; ?><input type="text" name="airwaybill_no" size="35"></td>
                <td style="width: 1%;" class="text-center">
                  <?php if (!$airwaybill_no) { ?>
                  <button id="button-invoice" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $button_generate; ?>" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i></button>
                  <?php } else { ?>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><?php if ($total['title'] == 'Total') { echo "<b>".$total['text']."<b>"; } else { echo $total['text']; } ?></b></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
